...
import { addInternDocs, addInternship, getAllInternshipData, getAllVerifiedInternshipData, getInternshipDataforStudent, verifyIntern } from "../controllers/internship.controller.js";
const router = Router()
...
router.route("/get-verified-interns").get(verifyJWT, getAllVerifiedInternshipData)
