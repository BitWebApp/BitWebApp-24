...
export default function ProjectForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let response;
      if (editId) {
        response = await axios.put(`/api/v1/project/edit/${editId}`, formData, {
          headers: {
  ...
  const fetchProject = async () => {
    try {
     ...
     console.log(localStorage);
      ...
      const response = await axios.get(`/api/v1/project/show/${userid}`
    ...
    <>
      ...
      <div className="w-full items-center justify-center flex my-4">
        <button
          ...
          className="bg-red-500 text-white w-full rounded-md p-4 text-center flex items-center justify-center my-2 hover:bg-red-600"
