...
export default function LandingPage() {
    return (
        <div className="container min-h-screen bg-white text-black bg-center bg-cover px-28 py-5 relative">
        <nav className="flex items-center">
            <img className="size-20 rounded-full" src="images/mesralogo.jpg"/>
            <ul className="flex-1 text-end">
                <li className="list-none inline-block px-5"><Link to="/log" className="no-underline px-2">Student Login</Link></li>
                <img className="inline-block" src="images/img_profile_24_outline.svg"></img>
                <li className="list-none inline-block px-5"><Link to="/log.a" className="no-underline px-2">Admin Login</Link></li>
                <img className="inline-block" src="images/img_profile_24_outline.svg"></img>
            </ul>
       ...
       <div className="mt-10">
        ...
        <img className="w-full xl:w-1/2 bottom-20 right-12" src="images/mesracampus.jpg"></img>
        <div className="mt-20">
            <Footer/>
        </div>
        </div>
